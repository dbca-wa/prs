...
class OverdueTasksEmail(View):
    """Basic view to handle an automatic email to PRS users assigned >0 tasks
    that are overdue.
    PRS user: in "PRS user" group, is_active == True.
    """
    http_method_names = ['get']

    def get(self, request, *args, **kwargs):
        # Obtain a list of 'current' PRS users.
        ...
        return HttpResponse('Overdue task emails sent to: {}'.format(
