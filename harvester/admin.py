...
class EmailedReferralAdmin(admin.ModelAdmin):
    def harvest_referral(modeladmin, request, queryset):
        ...
        for er in queryset:
            ...
            if not er.processed:
                ...
                actions.append(f"Emailed referral {er} is already processed")
            msg = ""
    ...
    list_display = ("received", "to_email", "from_email", "subject", "harvested", "attachments_url", "referral_url", "processed")
